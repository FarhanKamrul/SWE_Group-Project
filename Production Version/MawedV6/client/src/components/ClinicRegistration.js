        ...
        <Row justify="center" className="form-container">
            <Col xs={24} sm={18} md={12} lg={8}>
                ...
                >
                    ...
                    >
                        <Checkbox>I agree to the <a className="terms-link" href="#">terms and conditions</a></Checkbox>
                    </Form.Item>
                    <Form.Item>
                    ...
                    <Form.Item>
                        <div style={{ textAlign: 'center' }}>
                            Already have an account? <Link className="login-link" to="/clinic/login">Log in</Link>
                        </div>
                    </Form.Item>
                </Form>
            </Col>
